...
const AdminInvoiceViewAccepted = () => {
  ...
  const [showRejectInvoice, setShowRejectInvoice] = useState(false);
  ...
  return (
    <div className="admin-layout">
            ...
            <div className="invoice-header">
              ...
              <div className="invoice-actions">
                <button
                  ...
                  onClick={() => setShowRejectInvoice(!showRejectInvoice)}
                >
                  Reject Invoice
                </button>
                <button
      ...
      {showRejectInvoice && (
        <div className="modal-overlay" onClick={() => setShowRejectInvoice(false)}>
          <div className="modal-content reject-invoice-modal" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3>Reject Invoice</h3>
              <button className="close-btn" onClick={() => setShowRejectInvoice(false)}>×</button>
            </div>
            <div className="modal-body">
              <textarea
                placeholder="Provide reason for rejecting the invoice..."
                rows={6}
                className="reject-textarea"
              />
              <div className="modal-actions">
                <button className="btn-secondary" onClick={() => setShowRejectInvoice(false)}>
                  Cancel
                </button>
...
export default AdminInvoiceViewAccepted;